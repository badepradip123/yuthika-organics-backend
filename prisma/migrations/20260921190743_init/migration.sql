...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'PRODUCT_ADMIN', 'ORDER_MANAGER', 'INVENTORY_MANAGER', 'CUSTOMER');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('RAZORPAY', 'COD', 'OTHER');
...
-- CreateIndex
CREATE INDEX "product_variants_productId_weightGrams_idx" ON "product_variants"("productId", "weightGrams");
